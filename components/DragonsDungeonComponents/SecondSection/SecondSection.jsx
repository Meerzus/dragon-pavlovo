...
const products = [
    ...
    },
    {
        ...
        title: 'Каникулы',
        image: holidays,
        description: 'На протяжении всего периода каникул мы предлагаем увлекательные мероприятия, включающие испытания с настоящими животными, интерактивные лабиринты и задания с габаритным инвентарем. Музыкальное сопровождение, световые эффекты и веселое развлекательное шоу создадут атмосферу праздника и веселья. Проведите каникулы вместе с нами и создайте сказочные моменты, которые останутся с вами на всю жизнь!'
    },
    {
        id: 4,
        title: 'Выпускной',
